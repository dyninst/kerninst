...
// These are declared in this .h since it just happened to be included by 
// all the .c's that need to use them
uint32_t grab_cswitch_lock(kmutex_t *the_lock);
void release_cswitch_lock(uint32_t level, kmutex_t *the_lock);
