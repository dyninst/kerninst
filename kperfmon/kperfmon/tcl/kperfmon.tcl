...
#	    -side left -padx 4
    ...
    label .d.range.lab -text "Disassemble a range of memory" -font $helv12 \
	    -foreground $cornflowerBlueColor -relief groove
    ...
    label .d.range.bounds.top.from.lab -text "From-addr:" \
	    -font $helv12 -foreground $cornflowerBlueColor
