...
# Or perhaps you prefer University of Wisconsin-Madison colors
...
#	    -side left -padx 4
    ...
    label .d.range.lab -text "Disassemble a range of memory" -font $bannerFont \
	    -foreground $bannerFontColor -relief groove
    ...
    label .d.range.bounds.top.to.lab -text "To-addr:" -font $helv12bold
